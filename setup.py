...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "tbd_cnn-diagnostics = tbd_cnn.cli.diagnostic:main",
            "tbd_cnn-plot-results = tbd_cnn.cli.plot_results:main",
            "tbd_cnn-optimise-dataset-size = tbd_cnn.cli.optimise_dataset_size:main",
        ],
    },
